...
I build mobile apps, games and small tools — mostly Flutter and Godot, with a habit of
turning the boring parts of my own workflow into open-source packages.
...
- 🎞️ **[motion_helper](https://github.com/ba6ul/motion_helper)** — After Effects CEP helper panel for repetitive motion-design tasks
- ☕ **[chai-roulette](https://github.com/ba6ul/chai-roulette)** — Tiny HTML/CSS/JS toy that picks who makes the chai
- 🚧 **[comingsoon_staticwebsite](https://github.com/ba6ul/comingsoon_staticwebsite)** — Reusable static "coming soon" landing page
- 📄 **[html_css_js_portfolio](https://github.com/ba6ul/html_css_js_portfolio)** — Early hand-rolled portfolio, pre-Next.js
- 🖼️ **[inicons wallpapers](https://github.com/ba6ul/inicons_wallpaper.github.io)** — Wallpaper feed/JSON host for the inicons app
- 🐍 **[DSA-with-Python](https://github.com/ba6ul/DSA-with-Python)** — Sorting and searching algorithm practice
- 🎞️ ![After Effects](https://img.shields.io/badge/Adobe%20After%20Effects-CF96FD.svg?style=for-the-badge&logo=Adobe%20After%20Effects&logoColor=330066)
--->
